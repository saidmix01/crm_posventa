	   ...
	   <br>
	    ...
	    <section class="content">
	    	<nav aria-label="breadcrumb">
	         ...
	         <div class="card">
			  <div class="card-body">
			    <h3 align="center">Informe Histórico NPS interno</h3>
			    <hr>
			    <div>
			    ...
			    <table class="table" align="center">
				  <tbody align="center">
				  	<tr>
				  		  <th style="background-color: #B6B6B6;">Fecha</th>
					  	<?php foreach ($data_nps as $key) {?>
					      <td style="background-color: #EEEEEE;"><?=$key['fecha']?></td>
						<?php } ?>
					</tr>
					<tr>
						<th style="background-color: #B6B6B6;">NPS</th>
						<?php foreach ($data_nps as $key) {?>
					      <td><?=round($key['nps'])?>%</td>
						<?php } ?>
					</tr>
					<tr>
						<th style="background-color: #B6B6B6;">Ordenes Finalizadas</th>
						<?php foreach ($cant_ord_fin as $key) { ?>
							<td><?=$key['y']?></td>
						<?php } ?>
					</tr>
					<!-- <tr>
						<th style="background-color: #B6B6B6;">Encuestas enviadas</th>
						<?php foreach ($cant_enc_env as $key) { ?>
							<td><?=$key['y']?></td>
						<?php } ?>
					</tr> -->
					<tr>
						<th style="background-color: #B6B6B6;">Encuestas diligenciadas</th>
						<?php foreach ($cant_enc_resp as $key) { ?>
							<td><?=$key['y']?></td>
						<?php } ?>
					</tr>
				  </tbody>
