...
<body class="hold-transition sidebar-mini layout-fixed">
			...
			<section class="content">
				<div class="container-fluid" align="center" style="margin-top: 0%;">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?= base_url() ?>admin_presupuesto">Informes </a></li>
						</ol>
					</nav>
					<div id="Informes" class="row">
						<div class="card col-md-12">
							<div class="card-body">
								<div class="row">
									<div class="col-md-6">
										<label>Seleccione los meses a comparar</label>
										<select class="js-example-basic-multiple" name="meses[]" multiple="multiple" style="width: 100%" id="select_mes">
									...
									<div class="col-md-6">
										<input type="button" name="Graficar" id="graficar" value="Calcular" class="btn btn-primary">
									</div>
								</div>
								<hr>
	...
	<script>
		...
		$('#graficar').click(function() {
			var meses = $('#select_mes').val();
			var jsonString = JSON.stringify(meses);
			$.post("<?= base_url() ?>Informes/get_presupuesto?mes=1&jsonString=" + jsonString,
				function(data) {
