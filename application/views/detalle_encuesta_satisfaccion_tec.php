	    ...
	    <section class="content">
	     <nav aria-label="breadcrumb" class="container-fluid">
		  <ol class="breadcrumb">
		    ...
		    <li class="breadcrumb-item"><a href="javascript: history.go(-1)">Informe NPS por tecnico</a></li>
		    <li class="breadcrumb-item active" aria-current="page">Informe NPS por tecnico detallado</li>
		  </ol>
		</nav>
	         <div class="container">
	         	<div class="card">	
