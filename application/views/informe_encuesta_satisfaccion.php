	   ...
	   <br>
	    ...
	    <section class="content">
	         <div class="container">
	         	<div class="card">
				  <div class="card-body">
				    <h3 align="center">Informe encuesta de satisfaccion de clientes</h3>
				    <hr>
				    <div class="table-responsive" align="justify">
					 	<!--  Tabla usuarios  -->
						 <table id="example1" class="table table-sm table-bordered table-hover">
			                ...
			                <tbody>
			                	<?php 
			                		foreach ($respuestas->result() as $key) {
			                	 ?>
			                <tr align="center">
			                  <td align="justify"><?=$key->nit_real?></td>
			                  <td align="justify"><?=$key->nombres?></td>
			                  <td align="justify"><?=$key->numero?></td>
			                  <td align="justify"><?=$key->placa?></td>
							  <td align="justify"><?=$key->fecha?></td>
			                  <td><a href="<?=base_url()?>encuesta/detalle_encuesta_satisfaccion?ot=<?=$key->numero?>" class="btn btn-outline-info btn-sm"><i class="fas fa-eye"></i></a></td>
			                </tr>
			                <?php 
			                	}
			                 ?>
