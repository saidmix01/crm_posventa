						...
						<div class="card-body">
							<div class="col-12 col-sm-6 col-md-6">
								<div class="info-box">
									...
									<div class="info-box-content">
										<span class="info-box-text" style="font-size: 20px;">OPERARIOS <?= $bodega ?></span>
							...
							<div class="row container-fluid" id="">
								<div class="table-responsive">
									<!--  Tabla usuarios  -->
									<table id="example1" class="table table-lg table-bordered table-hover">
										<thead>
											<tr align="center">
												<th>NOMBRE</th>
												<th>VALOR</th>
										...
										<tbody>
											<?php
											foreach ($operarios->result() as $key) {
											?>
												<tr align="center">
													<td align="justify"><?= $key->nombres ?></td>
													<td>$<?= number_format($key->valor, 0, ",", ",") ?></td>
													<td><a href="<?= base_url() ?>admin_presupuesto/detalle_operarios?bodega=<?= $bodega ?>&ope=<?= $key->operario ?>&presu=<?= $presu ?>" class="btn btn-info btn-sm"><i class="far fa-eye"></i> Ver</a></td>
												</tr>
											<?php
											}
											?>
