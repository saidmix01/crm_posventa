    ...
    <section class="content">
        <div class="card">
            <div class="card-header" align="center">
                <h3><strong>Editar Cotización Sacyr</strong></h3>
            </div>
            <div class="card-body">
                    <div class="row">

                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                            <label class="control-label">Id cotización:</label>
                            <input readonly placeholder="ID cotización" class="form-control" type="number" id="kmVh" name="kmVh" value="<?= $id_cotizacion ?>">
                        </div>
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                            <label class="control-label">Placa:</label>
                            <input readonly placeholder="Escriba aquí la placa" class="form-control" type="text" id="placa" name="placa" value="<?= $placa ?>" onchange="cargarClase();">
                        </div>
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                        <label class="control-label">Orden de Trabajo:</label>
                        <input disabled placeholder="Escriba aquí la orden de trabajo" class="form-control" type="text" id="ordenT" name="ordenT" value="<?= $ordenT ?>">
                        </div>
                                    ...
                                    <th colspan="5">
                                        <table style="width: 100% ;">
                                            <tr>
                                                ...
                                                <th style="width: 50% ;text-align: end;" id="subtotalRepuestos"></th>
                                            </tr>
                                            <tr>
                                                <th style="width: 50% ;">Subtotal descuento</th>
                                                <th style="width: 50% ;text-align: end;" id="subTotalDescuentos"></th>
                                            </tr>
                                            <tr>
                                                <th style="width: 50% ;">Subtotal</th>
                                                <th style="width: 50% ;text-align: end;" id="subTotalRepuestosDesc"></th>
                                            </tr>
                                            <tr class="d-none">
                                                <th style="width: 50% ;">Total Sin Iva</th>
                                                <th style="width: 50% ;text-align: end;" id="cellValorTotalSinIVA"></th>
                                            </tr>
                                            <tr class="d-none">
                                                <th style="width: 50% ;">Total Con Iva</th>
                                                <th style="width: 50% ;text-align: end;" id="cellValorTotal"></th>
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <textarea disabled class="form-control" id="obs" rows="4" name="obs" placeholder="Escriba aquí las observaciones"><?= $observacion ?></textarea>
                    </div>
                    <div class="col-6">
...
<script>
    ...
    $(document).ready(function() {
        ...
        loadItemRepuestosCotizacion(id_cotizacion);


    });


    function loadItemRepuestosCotizacion(id_cotizacion) {

        document.getElementById('cargando').style.display = 'block';
        var cotizacion = new FormData();
        cotizacion.append('id_cotizacion', id_cotizacion);
        cotizacion.append('opcion', 2);//Editar
        ...
        xmlhttp.onreadystatechange = function() {
            if (xmlhttp.readyState === 4 && xmlhttp.status === 200) {
                ...
                document.getElementById('cotizadorItem').innerHTML = resp;
                loadItemManoObraCotizacion(id_cotizacion);


            }
        }
        xmlhttp.open("POST", "<?= base_url() ?>Sacyr/loadItemRepuestosCotizacion", true);
        xmlhttp.send(cotizacion);

    }

    function loadItemManoObraCotizacion(id_cotizacion) {


        var cotizacionMano = new FormData();
        cotizacionMano.append('id_cotizacion', id_cotizacion);
        cotizacionMano.append('opcion', 2);//Editar
        if (window.XMLHttpRequest) {
            xmlhttp = new XMLHttpRequest();
        } else {
            xmlhttp = new ActiveXObject("Microsoft.XMLHTTP");
        ...
        xmlhttp.onreadystatechange = function() {
            if (xmlhttp.readyState === 4 && xmlhttp.status === 200) {
                var respManoObra = xmlhttp.responseText;
                document.getElementById('tBodyManoObra').innerHTML = respManoObra;

                loadItemToTCotizacion(id_cotizacion);


            }
        }
        xmlhttp.open("POST", "<?= base_url() ?>Sacyr/loadItemManaObraCotizacion", true);
        xmlhttp.send(cotizacionMano);

    }

    function loadItemToTCotizacion(id_cotizacion) {


        var cotizacionToT = new FormData();
        cotizacionToT.append('id_cotizacion', id_cotizacion);
        cotizacionToT.append('opcion', 2);//Editar
        if (window.XMLHttpRequest) {
            xmlhttp = new XMLHttpRequest();
        } else {
            xmlhttp = new ActiveXObject("Microsoft.XMLHTTP");
        ...
        xmlhttp.onreadystatechange = function() {
            if (xmlhttp.readyState === 4 && xmlhttp.status === 200) {
                var respToT = xmlhttp.responseText;
                document.getElementById('tBodyToT').innerHTML = respToT;
        ...
        xmlhttp.open("POST", "<?= base_url() ?>Sacyr/loadItemToTCotizacion", true);
        xmlhttp.send(cotizacionToT);
    ...
    function validar_check(codigo,id) {
        ...
        sumarValoresTotales();
        updateAutorizacion(id,validar.value,'UpdateCotiRepuestos');
    }

    /* Funcion validar Check */
    function validar_checkManoObra(codigo,id) {
        ...
        updateAutorizacion(id,validar.value,'UpdateCotiManoObra');
    }
    ...
    function validar_checkToT(codigo) {
        ...
        calcularValorTotal_ToT();
        updateAutorizacion(id,validar.value,'UpdateCotiToT');
        ...
        if (validacion_1 && validacion_5) {
            switch (true) {
                case (validacion_4 > 0 && validacion_2):
                    ...
                    EnviarDatosCotizacion(placa, descModelo, km_actual, obs);
                    break;
    ...
    function EnviarDatosCotizacion(placa, descModelo, km_actual, obs) {
        document.getElementById('cargando').style.display = 'block';
                ...
                if (resp != null) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            window.close(); //Cerrar ventana de duplicidad...
                        }
    ...
    function updateAutorizacion(id,autorizado,url){
        document.getElementById('cargando').style.display = 'block';
        const form = new FormData();
        form.append('id',id);
        form.append('autorizado',autorizado);

        fetch("<?=base_url()?>Sacyr/"+url, {
            headers: {
            ...
            .then(function (json) {
                if (json['response'] == 'success') {
                    Swal.fire({
                        title: 'Exito',
                        text: 'Se ha realizado con exito la actualización del item seleccionado.',
                        icon: 'success',
                        confirmButtonText: 'Ok'
                    });
                    ...
                    Swal.fire({
                        title: 'Exito',
                        text: 'No se ha realizadola actualización del item seleccionado.',
                        icon: 'success',
                        confirmButtonText: 'Ok'
                    });
                }
            ...
            .catch(function (error) {
                Swal.fire({
                    ...
                    <br/><strong>Nota:</strong>Intente recargar la página nuevamente, si no funcione, reporte este error a sistemas!.`,
                    icon: 'warning',
                    confirmButtonText: 'Ok'
                });
            });
