    ...
    <section class="content">
        <div class="card">
            <div class="card-header" align="center">
                <h3><strong>Duplicar Cotización Sacyr</strong></h3>
            </div>
            <div class="card-body">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <textarea class="form-control" id="obs" rows="4" name="obs" placeholder="Escriba aquí las observaciones"><?= $observacion ?></textarea>
                    </div>
                    <div class="col-6">
...
<script>
    ...
    function loadItemRepuestosCotizacion(id_cotizacion) {
        ...
        cotizacion.append('opcion', 1); //Duplicar
    ...
    function loadItemManoObraCotizacion(id_cotizacion) {
        ...
        cotizacionMano.append('opcion', 1); //Duplicar
        if (window.XMLHttpRequest) {
            xmlhttp = new XMLHttpRequest();
        } else {
            xmlhttp = new ActiveXObject("Microsoft.XMLHTTP");
    ...
    function loadItemToTCotizacion(id_cotizacion) {
        ...
        cotizacionToT.append('opcion', 1); //Duplicar
        if (window.XMLHttpRequest) {
            xmlhttp = new XMLHttpRequest();
        } else {
            xmlhttp = new ActiveXObject("Microsoft.XMLHTTP");
