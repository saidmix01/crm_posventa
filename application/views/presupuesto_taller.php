...
<body class="hold-transition sidebar-mini layout-fixed">
				...
				<div class="container-fluid" align="center" style="margin-top: 0%;">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Presupuesto Posventa por taller</li>
						</ol>
					</nav>
					<div class="info-box">
						...
						<div class="info-box-content">
							<span class="info-box-text" style="font-size: 20px;">Presupuesto <?= $sede ?></span>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			var sede = "<?= $this->input->get('sede') ?>";
			//console.log(sede);

			//setInterval('cargar_tabla('+sede+')',1000);
			cargar_tabla(sede);
		});
		...
		function cargar_tabla(sede) {
			...
			xmlhttp.open("GET", "<?= base_url() ?>admin_presupuesto/real_time_taller?sede=" + sede, true);
			xmlhttp.send();
		}
	</script>
