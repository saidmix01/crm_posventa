...
<body class="hold-transition sidebar-mini layout-fixed" >
	    ...
	    <section class="content">
	    	<nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
			    ...
			    <li class="breadcrumb-item"><a href="<?=base_url()?>Informes/Informe_pac"><a href="<?=base_url()?>admin_presupuesto">Presupuesto Posventa</a></li>
			    <li class="breadcrumb-item active" aria-current="page">Presupuesto Posventa por sedes</li>
			    <li></li>
			  </ol>
			</nav>
						<div class="info-box" align="center">
			              ...
			              <div class="info-box-content">
			                <span class="info-box-text" style="font-size: 20px;">Presupuesto Total POSVENTA</span>
			                <span class="info-box-number" style="font-size: 15px;">
			                  $<?=number_format($total_presu,0,",",",")?>
	...
	<script type="text/javascript">
		function cargar_tabla() {
            ...
            xmlhttp.open("GET", "<?=base_url()?>admin_presupuesto/real_time_sedes?var=1", true);
            xmlhttp.send();
		}
		cargar_tabla();
		setInterval('cargar_tabla()',60000);
	</script>
	<script type="text/javascript">
		function buscar_presupuesto() {
            ...
            xmlhttp.open("GET", "<?=base_url()?>admin_presupuesto/presupuesto_sedes?fec_ini="+fecha_ini+"&fec_fin="+fecha_fin, true);
            xmlhttp.send();
