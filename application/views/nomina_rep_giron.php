...
<head>
	...
	<style type="text/css">
		.loader {
			...
			height: 100%;
			z-index: 9999;
			background: url('<?= base_url() ?>media/cargando7.gif') 50% 50% no-repeat rgb(249,24  9,24  9);
			opacity: .8;
			display: none;
		}
	</style>
...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #3D3D3D; ">
			...
			<div class="sidebar">
				...
				<div class="">
					<div class="image">
						<img src="<?= base_url() ?>media/logo/logo_codiesel.png" class="img-fluid"
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="card">
					<div class="card-body">
						<h3>Comisiones de Asesores CODIESEL</h3>
						<hr>
						<div class="card">
							<div class="card-header">
								<div class="row">
									<div class="col-md-2">
										<h3 class="card-title">Tabla de Comisiones</h3>
									</div>
									<div class="col-md-6" align="center">
										<form class="form-inline">
											<div class="form-group mb-2">
												<label for="mes" class="sr-only">Seleccione un Mes</label>
											...
											<div class="form-group mb-2">
												<label for="mes" class="sr-only">Seleccione un Mes</label>
												<select class="form-control form-control-sm" id="mes" onchange="load_tabla();">
									...
									<div class="col-md-4" align="right"><button class="btn btn-success btn-sm" onclick="toexcel();" aling="right">Descargar Excel</button></div>
								</div>
							</div>
							<!-- /.card-header -->
							<div class="card-body p-0">
								<table class="table" id="datatabla_tittle">
									<thead align="center">
										<tr style="font-size: 14px;">
											...
											<th>Comision %</th>
											<th>Comision $</th>
											<th>Comision/ventas</th>
											<th>Total Comisiones</th>
											<th>Detalles</th>
										</tr>
									</thead>
									<tbody align="center" id="datatabla">
	...
	<script type="text/javascript">
		...
		function load_tabla() {
			var result = document.getElementById("datatabla");
			...
			var boolValidateFecha = (ano == fecha.getFullYear() && mes >= fecha.getMonth() + 1);

			if (ano != "" && mes != "" && boolValidateFecha != true) {
				...
				xmlhttp.open("GET", "<?= base_url() ?>nomina/cargar_tabla_comisiones_asesores?mes="+mes+"&ano="+ano, true);
				xmlhttp.send();
			} else {
				Swal.fire({
					title: 'Advertencia!',
					html: `Debe seleccionar un año y mes.<br>
					Nota: No puede seleccionar el año y mes actual`,
					icon: 'error',
	...
	<script type="text/javascript">
		function toexcel() {
			$("#datatabla_tittle").table2excel({
				exclude: ".noExl",
				name: "Worksheet Name",
				filename: "Comisiones Asesores CODIESEL",//do not include extension
