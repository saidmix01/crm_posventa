	         ...
	         <div class="container">
	         	<div class="card">	
				  <div class="card-body">
				  		<div class="col-md-12">
							  	<?php 
				         			foreach ($data_Informe->result() as $data) {
				         		 ?>
							  	<h3 align="center">Respuestas de: <?=$data->cliente?></h3>
							  	<hr>
							  	<div class="row">
							  		<div class="col-md-3"><strong>NUMERO DE ORDEN:</strong></div>
							  		<div class="col-md-1" align="left"><span><?=$data->numero?></span></div>
							  		<div class="col-md-1"><strong>BODEGA</strong></div>
							  		<div class="col-md-2"><span><?=$data->descripcion?></span></div>
							  		<div class="col-md-1"><strong>TECNICO</strong></div>
							  		<div class="col-md-2" align="left"><span><?=$data->tecnico?></span></div>
							  		<div class="col-md-1"><strong>FECHA</strong></div>
							  		<div class="col-md-1"><span><?=$data->fecha?></span></div>
							  	</div>
							  	<hr>
							  	<div class="">
							  	<?php
									...
									<div class="row">
										<div class="col-md-3">
											<div class="card text-white <?=$estadop1?> mb-3" style="max-width: 18rem;">
											  <div class="card-header" style="font-size: 15.5px;">Satisfaccion con el concesionario (Mantenimiento Reparacion)</div>
