...
<body class="hold-transition sidebar-mini layout-fixed">
	         ...
	         <div class="container-fluid" align="center" style="margin-top: 0%;">
				<nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
				    ...
				    <li class="breadcrumb-item"><a href="<?=base_url()?>Informes/Informe_pac">Presupuesto Posventa</a></li>
				    <li class="breadcrumb-item"><a href="javascript:history.go(-1)">Presupuesto Posventa por sedes</a></li>
				    <li class="breadcrumb-item"><a href="javascript:history.go(-1)">Presupuesto Posventa por taller</a></li>
				    <li class="breadcrumb-item active" aria-current="page">Presupuesto Posventa por operación</li>
				  </ol>
				</nav>
						...
						<div class="info-box">
			              ...
			              <div class="info-box-content">
			                <span class="info-box-text" style="font-size: 20px;">Presupuesto <?=$bodega?></span>
	...
	<script type="text/javascript">
		function cargar_tabla() {
			...
			var bode="<?=$this->input->get('bodega')?>";
			var xmlhttp;
            ...
            xmlhttp.open("GET", "<?=base_url()?>admin_presupuesto/real_time_tipo_op?bodega="+bode, true);
            xmlhttp.send();
		}
	</script>
