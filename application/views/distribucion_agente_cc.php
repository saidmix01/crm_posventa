					...
					<div class="card-body">
						<nav>
							<div class="nav nav-tabs" id="nav-tab" role="tablist">
								<a class="nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Actuales</a>
								<a class="nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Futuras</a>
								<a class="nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Recordación</a>
							</div>
						</nav>
						<div class="tab-content" id="nav-tabContent">
							<div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
								...
								<table class="table table-hover" id="example1">
									...
									<tbody>
										<?php foreach ($ga_actuales->result() as $key) { ?>
											<tr align="center">
												<td><?=$key->placa?></td>
												<td><?=$key->nombre_propietario?></td>
												<td><?=$key->modelo?></td>
												<td><?=$key->campania?></td>
												<td>1000</td>
												<td><?=$key->fecha_estimada?></td>
												<td><?=$key->estado?></td>
												<td><a href="#" class="btn btn-info btn-sm"><i class="fas fa-plus"></i> Iniciar</a></td>
											</tr>
										<?php } ?>
									</tbody>
								</table>
