	         ...
	         <div class="container-fluid" align="center" style="margin-top: 0%;">
				...
				<div class="card">
					  <div class="card-body">
			            ...
			            <div class="info-box">
			              <span class="info-box-icon bg-warning elevation-1"><i class="fas fa-car-crash"></i></span>

			              <div class="info-box-content">
			                <span class="info-box-text" style="font-size: 25px;">MECANICA <?=$bodega?></span>
							 ...
							 <table id="example3" class="table table-sm table-bordered table-hover">
				                ...
				                <tbody>
					                ...
					                <tr align="center">
					                  ...
					                  <td><a href="<?=base_url()?>admin_presupuesto/cargar_detalle_cliente?bod=<?=$bodega?>&cliente=<?=$key['clase']?>&presupuesto=<?=$key['valor']?>&nit=<?=$key['nit']?>" class="btn btn-info btn-sm"><i class="far fa-eye"></i> Ver</a></td>
					                </tr>
				                <?php 
				                	}
				                }
