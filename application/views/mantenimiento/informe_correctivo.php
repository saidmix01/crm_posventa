...
<div class="content-wrapper">
    <section class="content">
        <div class="alert alert-light col-lg-12 text-center" role="alert">
            <h4>Informe de mantenimiento correctivo</h4>
        </div>
    </section>
    <!-- Main content -->
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-12 col-md-4 col-sm-6">
                        ...
                        <select class="form-control js-example-basic-single" id="sedeBodega" name="sedeBodega" required>
                    ...
                    <div class="table-responsive" id="tabla_uno">
                        <table class="table table-bordered" aria-describedby="descTable" id="tablatotal">
                            <thead>
                               ...
                               <!--  <th scope="col">IMG EVIDENCIA</th> -->
                                <th scope="col">URGENCIA</th>
                                <th scope="col">ENCARGADO</th>
                                <th scope="col">RESPUESTAS</th>
                               <!--  <th scope="col">IMG RESPUESTA</th> -->
...
<script>
    $(document).ready(function() {
        ...
        cargarInformecorrectivo();


    });


    function cargarInformecorrectivo() {
        var url = "<?= base_url() ?>mantenimiento/getInfcorrectivo";
    ...
    function BuscarFiltro() {
        ...
        var bodega = document.getElementById('sedeBodega').value;
        if (estado != "" || bodega != "") {
            document.getElementById('cargando').style.display = 'block';
            var url = "<?= base_url() ?>mantenimiento/getInfcorrectivo";
