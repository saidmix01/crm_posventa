	  ...
	  <div class="content-wrapper">
	   <br>
	    ...
	    <section class="content">
	         <div class="card">
			  <div class="card-body">
			    <h3 align="center">Comisiones de <?=$nombre?></h3>
			    <hr>
			    	...
			    	<table class="table table-bordered">
					  ...
					  <tbody>
					    ...
					    <tr>
					      ...
					      <td>$<?=number_format($key['descuento'],0,",",",")?></td>
					      <td>$<?=number_format($key['venta_neta'],0,",",",")?></td>
					      <td>$<?=number_format($key['costo_neto'],0,",",",")?></td>
					      <td>$<?=number_format($key['utilidad'],0,",",",")?></td>
					      <td><?=number_format($key['margen_bruto'],2,",",",")?>%</td>
					      <td><?=$key['tipo']?></td>
					    </tr>
						<?php } ?>
					  </tbody>
