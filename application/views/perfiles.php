	   ...
	   <br>
	    ...
	    <section class="content">
	         <div class="card">
			  <div class="card-body">
			    <nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
				    <li class="breadcrumb-item"><a href="<?=base_url()?>login/iniciar">Perfiles /</a></li>
				  </ol>
				</nav>
			  </div>
			</div>
		  ...
		  <div class="card-header" align="center">
		    <h3>Perfiles de acceso a los menus</h3>
		  </div>
		  <div class="card-body">
		  	<!--  Tabla perfiles  -->
		    <table class="table table-sm table-hover">
			  ...
			  <tbody align="center">
			    ...
			    <tr>
			      ...
			      <td>
			      	<a class="btn btn-secondary btn-sm" style="background-color: #2F3C4F;" href="<?=base_url()?>admin/listar_permisos_menus?id=<?=$key->id_perfil?>">Ver Permisos</a>
			      </td>
			    </tr>
			    <?php 
			    	}
