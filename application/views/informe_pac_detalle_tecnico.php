	    ...
	    <section class="content">
	    	...
	    	<nav aria-label="breadcrumb" class="container-fluid">
			  <ol class="breadcrumb">
			    ...
			    <li class="breadcrumb-item"><a href="#" onclick="window.history.back();">Informe PAC por tecnico</a></li>
			    <li class="breadcrumb-item active" aria-current="page">Buscar nps tecnicos por día</li>
			  </ol>
			</nav>
	         <div align="center" >
	...
	<script>
		...
		function load_data_tec(){
			...
			if ( fecha <= fecha_actual ) {
				...
				xmlhttp.open("GET", "<?= base_url() ?>Informes/validar_Informe_pac_detalle_tecnico_byFecha?fecha=" + fecha + "-01&sede=<?= $sede ?>", true);
				xmlhttp.send();
