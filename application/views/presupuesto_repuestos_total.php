...
<body class="hold-transition sidebar-mini layout-fixed">
	    ...
	    <section class="content">
	         <div class="container-fluid" align="center" style="margin-top: 0%;">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
					    <li class="breadcrumb-item"><a href="<?=base_url()?>admin_presupuesto">Presupuesto /</a></li>
					</ol>
				</nav>	
				<div class="card">
				  <div class="card-body">
						<form>
						  <div class="row">
						    <div class="col">
						      <input type="date" class="form-control"  id="fec_ini" required="true">
						    </div>
						    <div class="col">
						      <input type="date" class="form-control" id="fec_fin" required="true">
						    </div>
						    <div class="col">
						      <a href="#" onclick="buscar_presupuesto()" class="btn btn-info"><i class="fas fa-search"></i> Buscar</a>
						    </div>
						  </div>
						</form>
				  </div>
				</div>
				<div class="card card-info" id="real_time">
					 
				</div>
	         </div>
	        <!-- <a href="#" onclick="cargar_tabla()" class="btn btn-secondary">hola</a>-->
	    </section>
	    <!-- /.content -->
	  </div>
	  <!-- /.content-wrapper -->
	...
	<div class="modal fade" id="modal_result" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="exampleModalLabel">Resultados de busqueda</h5>
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	          <span aria-hidden="true">&times;</span>
	        </button>
	      </div>
	      <div class="modal-body" id="resultado">
	        <div class="card card-info">
					 <div class="card-header">
					    <h3 class="card-title" style="font-size: 35px"><i class="far fa-building"></i> Presupuesto Repuestos CODIESEL</h3>
					    <div class="card-tools">
					    </div>
					  </div>
					  <div class="card-body" align="center" id="resultado">
					    
		                  <!-- /.col -->
					  </div>
					  <!-- /.card-body -->
					  <div class="card-footer">
					    <a href="<?=base_url()?>admin_presupuesto/presupuesto_sedes" class="btn btn-block btn-outline-info btn-sm"><i class="fas fa-eye"></i> Ver Mas</a>
					  </div>
				</div>
	      </div>
	    </div>
	...
	<script type="text/javascript">
		function cargar_tabla() {
			var result = document.getElementById("real_time");
			var xmlhttp;
            ...
            xmlhttp.open("GET", "<?=base_url()?>admin_presupuesto/real_time?var=1", true);
            xmlhttp.send();
		}
		setInterval('cargar_tabla()',1000);
	</script>
	<script type="text/javascript">
		function buscar_presupuesto() {
			var result = document.getElementById("resultado");
			var fecha_ini = $("#fec_ini").val();
			var fecha_fin = $("#fec_fin").val();
			var xmlhttp;
            if (window.XMLHttpRequest) {
                xmlhttp = new XMLHttpRequest();
            } else {
            ...
            xmlhttp.open("GET", "<?=base_url()?>admin_presupuesto/repuestos_total?fec_ini="+fecha_ini+"&fec_fin="+fecha_fin, true);
            xmlhttp.send();
