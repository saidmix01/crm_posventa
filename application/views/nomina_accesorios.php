	  ...
	  <div class="content-wrapper">
	   <br>
	    ...
	    <section class="content">
	         <div class="card">
			  <div class="card-body">
			    <h3 align="center">Informe nomina accesorios</h3>
			    <hr>
				<div class="container-fluid">
					<form class="form-inline" action="<?=base_url()?>Nomina/nomina_accesorios" method="POST">
					  ...
					  <button class="btn btn-success mb-2 ml-5" onclick="exportTableToExcel('example1','Nomina Accesorios');">Descargar Excel</button>					
					</form>					
				</div>
						 ...
						 <table id="example1" class="table table-sm table-bordered table-hover">
			                ...
			                <tbody>
				                ...
				                <tr align="center">
				                  ...
				                  <td>$<?=number_format($key->REPUESTOS + $key->ACCESORIOS,0,",",".")?></td>
				                </tr>
				                <?php 
				                	}
				                ?>
