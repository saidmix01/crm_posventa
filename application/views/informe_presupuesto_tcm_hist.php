	    ...
	    <section class="content">
	    	<nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
			    ...
			    <li class="breadcrumb-item"><a href="javascript: history.go(-1)">Informe presupuesto histórico</a></li>
			    <li class="breadcrumb-item active" aria-current="page">Informe TCM Histórico</li>
			  </ol>
			</nav>
			<div class="card">
			  <div class="card-body">
			...
			data: [
				{
					...
					showInLegend: true,
					yValueFormatString: "'$'#,##0",
					dataPoints: <?php echo json_encode($point4, JSON_NUMERIC_CHECK); ?>
				},{
					type: "line",
					name: "TCM",
					color: "#2F3C4F",
					showInLegend: true,
					yValueFormatString: "'$'#,##0",
					dataPoints: <?php echo json_encode($line_tcm, JSON_NUMERIC_CHECK); ?>
				}
			]
		});
