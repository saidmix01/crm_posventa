			  ...
			  <div class="card-body">
			    <nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
				    ...
				    <li class="breadcrumb-item active" aria-current="page">Acceso a los menus</li>
				  </ol>
				</nav>
			  </div>
			</div>
				    ...
				    <tr>
				      ...
				      <td>
							  ...
							  if($row['estado'] == "Activo"){
				      		 ?>
				      		 <form action="<?=base_url()?>admin/delete_permisos_menu" method="POST">
					      		 <input type="hidden" name="menu" value="<?=$row['menu']?>">
					      		 <input type="hidden" name="perfil" value="<?=$row['perfil']?>">
					      		 <button class="btn btn-success btn-sm"><?=$row['estado']?></button>
				      		 </form>
				      		 <?php 
				      		 	}else if($row['estado'] == "Inactivo"){
				      		  ?>
				      		 <form action="<?=base_url()?>admin/crear_permisos_menus" method="POST">
					      		 <input type="hidden" name="menu" value="<?=$row['menu']?>">
					      		 <input type="hidden" name="perfil" value="<?=$row['perfil']?>">
					      		 <button class="btn btn-danger btn-sm"><?=$row['estado']?></button>
				      		 </form>
				      		 <?php 
				      		 	}
				      		  ?>
				      ...
				      <td>
				      	<a href="<?=base_url()?>admin/listar_permisos_submenus?menu=<?=$row['id_menu']?>&perfil=<?=$row['perfil']?>" class="btn btn-primary btn-sm" style="background-color: #2F3C4F;">
