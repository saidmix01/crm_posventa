	  ...
	  <div class="content-wrapper">
	   <br>
	    ...
	    <section class="content">
	         <div class="card">
			  <div class="card-body">
			    <h3 align="center">Informe nomina servicio y repuestos</h3>
			    <hr>
				<div class="container-fluid">
					<form class="form-inline" action="<?=base_url()?>Nomina/nomina_serv_rep" method="POST">
					  ...
					  <button class="btn btn-success mb-2 ml-5" onclick="exportTableToExcel('example1','Nomina Servicios y Repuestos');">Descargar Excel</button>					
					</form>					
				</div>
						 ...
						 <table id="example1" class="table table-sm table-bordered table-hover">
			                ...
			                <tbody>
			                	<?php 
			                	 ...
			                	 ?>
				                <tr align="center">
				                  <td><?=$key->vendedor_detalle?></td>
				                  <td>$<?=number_format($key->ACCESORIOS,0,",",".")?></td>
				                  <td>$<?=number_format($key->REPUESTOS,0,",",".")?></td>
				                  <td>$<?=number_format($key->LUBRICANTES,0,",",".")?></td>
				                  <td>$<?=number_format($key->REPUESTOS + $key->ACCESORIOS + $key->LUBRICANTES,0,",",".")?></td>
				                </tr>
				                <?php 
				                	}
				                ?>
				                <?php 
				                 ...
				                 <tr align="center" style="background-color: gray">
				                 	<td style="width: 540px;"><?=$key['total']?></td>
				                 	<td>$<?=number_format($key['acc'],0,",",".")?></td>
									<td>$<?=number_format($key['rep'],0,",",".")?></td>
									<td>$<?=number_format($key['lub'],0,",",".")?></td>
									<td>$<?=number_format($key['to'],0,",",".")?></td>
				                 </tr>
				             <?php } ?>
			               </tbody>
			            </table>
