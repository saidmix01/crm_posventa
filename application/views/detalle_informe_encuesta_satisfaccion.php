	         ...
	         <div class="container">
	         	<div class="card">	
				  <div class="card-body">
				  	...
				  	<hr>
				  	<div class="row">
				  		<div class="col-md-2"><strong>NUMERO DE ORDEN:</strong></div>
				  		<div class="col-md-2" align="left"><span><?=$data->numero?></span></div>
				  		...
				  		<div class="col-md-4" align="left"><span><?=$data->tecnico?></span></div>
				  	</div>
				  	<?php } ?>
				  	<hr>
				  	<div class="row">
				  	<?php foreach ($data_respuestas->result() as $data) {
				  		$estadop1 = "";
				  		$estadop2 = "";
				  		$estadop3 = "";
				  		$estadop4 = "";
