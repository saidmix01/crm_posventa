...
<body class="hold-transition sidebar-mini layout-fixed">
                            ...
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="idCita" id="idCita" class="form-control" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body" id="external-events">
                                <!-- <div id='mydraggable' class="fc-event" draggable="true" style="background-color: red;" data-event='{ "title": "my event", "duration": "03:00" }'>drag me</div> -->
                            </div>
                            <div class="card-footer">
                                <button type="button" class="btn btn-block btn-outline-success btn-flat" onclick="confirmarAgendaGral();"  id="btnConfirmarAgenda" style="display: none;">Confirmar Agenda</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-10">
                        <div class="card">
                            <div class="card-header">
                                <label for="">Seleccione una bodega</label>
                                <select name="comboSede" id="comboSede" class="form-control form-control-lg" onchange="loadCalendario();">
    ...
    <!-- CREAR COTIZACION MODAL -->
    <div class="modal" tabindex="-1" id="modalListaChequeo" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" id="formsOpe">
                    <form id="formAgendarCita">
                        <div class="form-row">
                            <div class="col">
                                <label for="">Nombre Encargado</label>
                                <input type="text" name="nomEncargado" id="nomEncargado" class="form-control">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col">
                                <label for="">Lista de Chequeo</label>
                                <textarea class="form-control" rows="3" id="listaChequeo" name="listaChequeo" placeholder="Escriba Algo ..."></textarea>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" onclick="confirmarAgenda();">Confirmar</button>
                </div>
            </div>
        </div>
    </div>

        <!-- VER INFO COTIZACION MODAL -->
        <div class="modal" tabindex="-1" id="verInfoCitaOperacionModal" role="dialog">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Detalle Operación</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" id="formInfoOpe">
    ...
    <script type="text/javascript">
        ...
        const usu = "<?php echo $this->session->userdata('user');?>";
    </script>

    <script src="<?= base_url() ?>dist/js/demo.js"></script>
    <script src="<?= base_url() ?>js/AgendaTaller/agenda.js?val=1"></script>
    <?php
