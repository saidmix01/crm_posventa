...
<script>
	/* Funcionalidad del select motivo de visita */
	function areaOtro(value) {
	...
	function cambiarSemaforo(value) {
		if (value === 'rojo') {
			document.getElementById('contenidoRojo').disabled = false;
			document.getElementById('contenidoAmarillo').disabled = true;
			document.getElementById('contenidoVerde').disabled = true;
			$( "#contenidoRojo" ).focus();
		}
		else if(value === 'amarillo') {
			document.getElementById('contenidoRojo').disabled = true;
			document.getElementById('contenidoAmarillo').disabled = false;
			document.getElementById('contenidoVerde').disabled = true;
			$( "#contenidoAmarillo" ).focus();
		}
		else if(value === 'verde') {
			document.getElementById('contenidoRojo').disabled = true;
			document.getElementById('contenidoAmarillo').disabled = true;
			document.getElementById('contenidoVerde').disabled = false;
			$( "#contenidoVerde" ).focus();
		}
	}
</script>
