	   ...
	   <br>
	    ...
	    <section class="content">
	         <div class="card container">
			  <div class="card-body">
			  	<h3 style="text-align: center;">Ingreso relación envio Garantias</h3>
			  	<hr>
			    <form method="POST" action="<?=base_url()?>garantias/insert_rel_envio_garantias">
			      <div class="form-group">
				    <label for="orden">Numero de orden(*)</label>
				    <input type="text" class="form-control" id="orden" name="orden" required="true">
				  </div>
				  <div class="form-group">
				    <label for="transaccion">Numero de Transacción(*)</label>
				    <input type="text" class="form-control" id="transaccion" name="transaccion" required="true">
				  </div>
				  <div class="form-group">
				    <label for="guia">Numero de Guia(*)</label>
				    <input type="text" class="form-control" id="guia" name="guia" required="true">
				  </div>
				  <div class="form-group">
				    <label for="fecha">Fecha(*)</label>
				    <input type="date" class="form-control" id="fecha" name="fecha" required="true">
				  </div>
				  <div align="center"><button type="submit" class="btn btn-primary">Guardar Datos</button></div>
				</form>
			  </div>
			</div>
	    </section>
