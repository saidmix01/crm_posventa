	    ...
	    <section class="content">
	    	<nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
			    ...
			    <li class="breadcrumb-item active" aria-current="page">Informe MO Histórico</li>
			  </ol>
			</nav>
	         <div class="card">
			  <div class="card-body">
	...
	<?php 
	 ...
	 <script type="text/javascript">
	 	function cargar_sedes() {
            ...
            xmlhttp.open("GET", "<?=base_url()?>admin_presupuesto/Informe_historico_mo_sedes", true);
            xmlhttp.send();
