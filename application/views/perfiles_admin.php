...
<body class="hold-transition sidebar-mini layout-fixed">
	   ...
	   <br>
	         ...
	         <div class="card">
			  <div class="card-body">
			    <nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
				    <li class="breadcrumb-item"><a href="<?=base_url()?>perfiles/">Perfiles /</a></li>
				  </ol>
				</nav>
			  </div>
			</div>
	    <div class="card">
		  ...
		  <div class="card-body">
		    <div class="row">
		    	<div class="col-md-12">
		    		<a class="btn btn-secondary btn-sm" href="#" data-toggle="modal" data-target="#modal-crear"  style="background-color: #2F3C4F;">Crear Perfil</a>
		    	</div>
		    </div>
		    <hr>
		    <table id="example1" class="table table-bordered table-hover table-sm">
			  ...
			  <tbody>
			  	<?php 
			  	 ...
			  	 ?>
			    <tr align="center">
			      <th scope="row"><?=$key->perfil?></th>
			      <td>
			      	<!--<?=base_url()?>perfiles_admin/update?id_perfil=<?=$key->id_perfil?>-->
			      	 <a href="#" onclick="mostrarsubmenus('<?=$key->id_perfil?>')">
	                  <i class="far fa-edit btn btn-warning" style="background-color: #D79408; color: #fff;"></i>
	                </a>
			      	<a href="<?=base_url()?>perfiles_admin/delete?id_perfil=<?=$key->id_perfil?>" class="">
	...
	<div class="modal fade" id="modal-crear" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="exampleModalLabel">Crear Perfiles</h5>
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	          <span aria-hidden="true">&times;</span>
	        </button>
	      </div>
	      <div class="modal-body">
	        <form method="post" action="<?=base_url()?>perfiles_admin/crear_pefil">
	        	<div class="form-group row">
	        		<div class="col-md-12">
	        			<label for="nombre_perfil">Nombre del perfil</label>
	        			<input type="text" name="nombre_perfil" required="true" placeholder="Escriba algo" class="form-control">
	        		</div>
	        	</div>
	        	<div class="row" align="center">
	        		<div class="col-md-12">
	        			<button class="btn btn-secondary">Crear Perfil</button>
	        		</div>
	        	</div>
	        </form>
	      </div>
	...
	<div class="modal fade" id="modal-editar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form method="post" action="<?=base_url()?>perfiles_admin/actualizar_perfil">
	        	<div class="form-group row">
	        		<div class="col-md-12" id="perfiles_content">
	        			<label for="nombre_perfil">Nombre del perfil</label>
	        			<div id="perfiles_content">
	        	...
	        	<div class="row" align="center">
	        		<div class="col-md-12">
	        			<button class="btn btn-secondary">Actualizar Perfil</button>
	        		</div>
	        	</div>
	        </form>
	      </div>
	...
	<!-- Funcion para traducir el datatable -->
	<script>
	...
	<!--  funcion ajax para actualizar perfil  -->
	<script type="text/javascript">
		function mostrarsubmenus(perfil) {
			var result = document.getElementById("perfiles_content");
			var xmlhttp;
            ...
            console.log(perfil);
            xmlhttp.open("GET", "<?=base_url()?>perfiles_admin/info_update?idp=" + perfil , true);
            xmlhttp.send();
            if(perfil != null){
	...
	<!--  alerts que dan informacion al usuario  -->
	<?php 
	...
	<?php 
	 ...
	 <?php 
	  ...
	  ?>
	  <!--  Funcion que cierra los alerts a los 1.5 seg  -->
	 <script type="text/javascript">
	 	setTimeout(function(){ 
