			...
			<div class="row">
				<div class="col-12 col-sm-6 col-md-3">
					<div class="info-box">
						...
						<div class="info-box-content">
							<span class="info-box-text">Total Posventa</span>
							<span class="info-box-number">
								$<?= number_format($to_posv, 0, ",", ".") ?>
							</span>
						</div>
						<!-- /.info-box-content -->
					</div>
				...
				<div class="col-12 col-sm-6 col-md-3">
					<div class="info-box mb-3">
						<span class="info-box-icon bg-danger elevation-1"><i class="fas fa-chart-line"></i></i></span>

						<div class="info-box-content">
							<span class="info-box-text">NPS Colmotores</span>
							<?php foreach ($cal_pac->result() as $key) { ?>
								<span class="info-box-number"><?= round($key->Calificacion, 2) ?>% / 81%</span>
							<?php } ?>
						</div>
						<!-- /.info-box-content -->
					</div>
				...
				<div class="col-12 col-sm-6 col-md-3">
					<div class="info-box mb-3">
						...
						<div class="info-box-content">
							<span class="info-box-text">NPS Codiesel</span>
							<span class="info-box-number"><?= round($nps_int, 2) ?>% / 81%</span>
						</div>
						<!-- /.info-box-content -->
					</div>
					<!-- /.info-box -->
				...
				<div class="col-12 col-sm-6 col-md-3">
					<div class="info-box mb-3">
						...
						<div class="info-box-content">
							<span class="info-box-text">Total Inventario</span>
							<span class="info-box-number">$<?= number_format($to_inv, 0, ",", ".") ?></span>
						</div>
						<!-- /.info-box-content -->
					</div>
					<!-- /.info-box -->
			...
			<div class="row">
				<div class="col-md-8">
					<div class="card card-info" style="transition: all 0.15s ease 0s; height: inherit; width: inherit;">
						<div class="card-header">
							<h3 class="card-title">Total vendido POSVENTA</h3>
				...
				<div class="col-md-4">
					<div class="info-box bg-default" style="background-color: #4F81BC">
						...
						<div class="info-box-content">
							<span class="info-box-text">Sede Girón</span>
							<span class="info-box-number"><?= round($porcen_giron) ?>%</span>

							<div class="progress">
								<div class="progress-bar" style="width: <?= round($porcen_giron) ?>%"></div>
							</div>
							<span class="progress-description" style="white-space: normal;">
								Falta <?= round(100 - $porcen_giron) ?>% para completar el objetivo del mes
							</span>
						</div>
						<!-- /.info-box-content -->
					</div>
					<div class="info-box bg-default" style="background-color: #C0504E">
						...
						<div class="info-box-content">
							<span class="info-box-text">Sede La Rosita</span>
							<span class="info-box-number"><?= round($porcen_rosita) ?>%</span>

							<div class="progress">
								<div class="progress-bar" style="width: <?= round($porcen_rosita) ?>%"></div>
							</div>
							<span class="progress-description" style="white-space: normal;">
								Falta <?= round(100 - $porcen_rosita) ?>% para completar el objetivo del mes
							</span>
						</div>
						<!-- /.info-box-content -->
					</div>
					<div class="info-box bg-default" style="background-color: #23BFAA">
						...
						<div class="info-box-content">
							<span class="info-box-text">Sede Cúcuta Boconó</span>
							<span class="info-box-number"><?= round($porcen_bocono) ?>%</span>

							<div class="progress">
								<div class="progress-bar" style="width: <?= round($porcen_bocono) ?>%"></div>
							</div>
							<span class="progress-description" style="white-space: normal;">
								Falta <?= round(100 - $porcen_bocono) ?>% para completar el objetivo del mes
							</span>
						</div>
						<!-- /.info-box-content -->
					</div>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="info-box bg-default" style="background-color: #9BBB58">
						...
						<div class="info-box-content">
							<span class="info-box-text">Sede Barrancabermeja</span>
							<span class="info-box-number"><?= round($porcen_barranca) ?>%</span>

							<div class="progress">
								<div class="progress-bar" style="width: <?= round($porcen_barranca) ?>%"></div>
							</div>
							<span class="progress-description" style="white-space: normal;">
								Falta <?= round(100 - $porcen_barranca) ?>% para completar el objetivo del mes
							</span>
						</div>
						<!-- /.info-box-content -->
					</div>
				...
				<div class="col-md-4">
					<div class="info-box bg-default" style="background-color: #7D6895">

						<div class="info-box-content">
							<span class="info-box-text">Sede Solochevrolet</span>
							<span class="info-box-number"><?= round($porcen_soloc) ?>%</span>

							<div class="progress">
								<div class="progress-bar" style="width: <?= round($porcen_soloc) ?>%"></div>
							</div>
							<span class="progress-description" style="white-space: normal;">
								Falta <?= round(100 - $porcen_soloc) ?>% para completar el objetivo del mes
							</span>
						</div>
						<!-- /.info-box-content -->
					</div>
				...
				<div class="col-md-4">
					<div class="info-box bg-default" style="background-color: #559DB0">

						<div class="info-box-content">
							<span class="info-box-text">Sede Chevropartes</span>
							<span class="info-box-number"><?= round($porcen_chev) ?>%</span>

							<div class="progress">
								<div class="progress-bar" style="width: <?= round($porcen_chev) ?>%"></div>
							</div>
							<span class="progress-description" style="white-space: normal;">
								Falta <?= round(100 - $porcen_chev) ?>% para completar el objetivo del mes
							</span>
						</div>
						<!-- /.info-box-content -->
					</div>
...
<div class="table-responsive">
	<table class="table">
		...
		<tbody align="center">
			...
			$tall_di_ba[] = array('sede' => 'Taller Diesel B/meja', 'total' => $v_d_tall_di_ba->total, 'porcen_general' => $porcen_tall_di_ba, 'meta' => $meta_di_ba);


			$tall_gas_ba[] = array('sede' => 'Taller Gasolina B/meja', 'total' => $v_d_tall_gas_ba->total, 'porcen_general' => $porcen_tall_gas_ba, 'meta' => $meta_gas_ba);


			$tall_mos_ba[] = array('sede' => 'Mostrador B/meja', 'total' => $v_d_tall_mos_ba->total, 'porcen_general' => $porcen_tall_mos_ba, 'meta' => $meta_mos_ba);

			?>
			<!--GENERAL-->
			<tr>
				<th style="text-align: left;"><i class="fas fa-arrow-down"></i> <button type="button" class="btn btn-link" onclick="mostrar_sedes();"><?= $pres_codiesel[0]['sede'] ?></button></th>
			...
			<tr id="t_sedes_giron" style="background-color: #ABB2B9;">
				<th style="text-align: left;">&nbsp;&nbsp;<i class="fas fa-arrow-right"></i> <button type="button" class="btn btn-link" onclick="mostrar_tall_g();"><?= $data_sedes[0]['sede'] ?></button></th>
			...
			<tr id="tall_di_g" style="background-color: #ABB2B9;">
				<th style="text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-arrow-right"></i> <button type="button" class="btn btn-link" href="#" onclick="mostrar_det_tall_di_g();"><?= $tall_di_g[0]['sede'] ?></button></th>
			...
			<tr id="tall_gas_g" style="background-color: #ABB2B9;">
				<th style="text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-arrow-right"></i> <button type="button" class="btn btn-link" onclick="mostrar_det_tall_gas_g();"><?= $tall_gas_g[0]['sede'] ?></button></th>
			...
			<tr id="tall_lyp_g" style="background-color: #ABB2B9;">
				<th style="text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-arrow-right"></i> <button type="button" class="btn btn-link" onclick="mostrar_det_tall_lyp_g();"><?= $tall_lyp_g[0]['sede'] ?></button></th>
			...
			<tr id="t_sedes_rosita" style="background-color: #B2BABB;">
				<th style="text-align: left;">&nbsp;&nbsp;<i class="fas fa-arrow-right"></i> <button type="button" class="btn btn-link" onclick="mostrar_tall_ro();"><?= $data_sedes[1]['sede'] ?></button></th>
			...
			<tr id="tall_gas_ro" style="background-color: #B2BABB;">
				<th style="text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-arrow-right"></i> <button type="button" class="btn btn-link" onclick="mostrar_det_tall_ro();"><?= $tall_ro[0]['sede'] ?></button></th>
			...
			<tr id="t_sedes_barranca" style="background-color: #EAECEE;">
				<th style="text-align: left;">&nbsp;&nbsp;<i class="fas fa-arrow-right"></i> <button type="button" class="btn btn-link" onclick="mostrar_tall_ba();"><?= $data_sedes[2]['sede'] ?></button></th>
			...
			<tr id="tall_di_ba" style="background-color: #EAECEE;">
				<th style="text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-arrow-right"></i> <button type="button" class="btn btn-link" onclick="mostrar_det_tall_di_ba();"><?= $tall_di_ba[0]['sede'] ?></button></th>
			...
			<tr id="tall_gas_ba" style="background-color: #EAECEE;">
				<th style="text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-arrow-right"></i> <button type="button" class="btn btn-link" onclick="mostrar_det_tall_gas_ba();"><?= $tall_gas_ba[0]['sede'] ?></button></th>
			...
			<tr id="t_sedes_bocono" style="background-color: #D5DBDB;">
				<th style="text-align: left;">&nbsp;&nbsp;<i class="fas fa-arrow-right"></i> <button type="button" class="btn btn-link" onclick="mostrar_tall_bo();"><?= $data_sedes[3]['sede'] ?></button></th>
			...
			<tr id="tall_di_bo" style="background-color: #D5DBDB;">
				<th style="text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-arrow-right"></i> <button type="button" class="btn btn-link" onclick="mostrar_det_tall_di_bo();"><?= $tall_di_bo[0]['sede'] ?></button></th>
			...
			<tr id="tall_gas_bo" style="background-color: #D5DBDB;">
				<th style="text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-arrow-right"></i> <button type="button" class="btn btn-link" onclick="mostrar_det_tall_gas_bo();"><?= $tall_gas_bo[0]['sede'] ?></button></th>
			...
			<tr id="tall_lyp_bo" style="background-color: #D5DBDB;">
				<th style="text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-arrow-right"></i> <button type="button" class="btn btn-link" onclick="mostrar_det_tall_lyp_bo();"><?= $tall_lyp_bo[0]['sede'] ?></button></th>
