											...
											<div class="col-md-6" id="nose">
												<div class="card card-info">
													...
													<div class="card-footer">
														<a href="<?= base_url() ?>admin_presupuesto/detalle_mecanica?bod=<?= $key['bodega'] ?>&razon=<?= $key['nombre'] ?>&presupuesto=<?= $key['valor'] ?>" class="btn btn-block btn-outline-info btn-sm"><i class="fas fa-eye"></i> Ver Mas</a>
													</div>
												</div>
											</div>
								<?php
